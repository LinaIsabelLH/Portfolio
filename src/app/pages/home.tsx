  ...
  return (
    <div>
      ...
      <Section id="accueil" title="Accueil">
        <h1>Bonjour! Bienvenu(e) sur mon portfolio!</h1>
        <p>
          Je suis Lina Isabel, Développeur d&apos;Applications Web et Mobile
          Fullstack
        </p>
      </Section>
      ...
      <Section id="competences" title="Compétences">
        ...
        <h2>Front End</h2>
        <h2>Back End</h2>
        <h2>Les technos que j&apos;ai travaillé</h2>
