...
const Footer = () => {
  return (
    <div className="flex flex-wrap z-10 justify-center items-center mt-auto w-full gap-x-2.5 gap-y-0 max-[1100px]:w-[calc(100%-40px)] max-[1100px]:h-auto max-[1100px]:p-[15px_20px] max-[1100px]:gap-[5px]">
